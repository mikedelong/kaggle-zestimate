...
additional_columns_to_drop = ['taxvaluedollarcnt', 'landtaxvaluedollarcnt', 'structuretaxvaluedollarcnt',
                              'taxamount']
...
train_columns_to_drop = ['parcelid', 'logerror', 'transactiondate', 'taxvaluedollarcnt'] + additional_columns_to_drop
x_train = train_df.drop(train_columns_to_drop, axis=1)
# y_train = train_df['logerror'].values.astype(np.float32)
y_train = train_df['taxvaluedollarcnt'].values.astype(np.float32)
...
xgb_boost_rounds = 9000  # was 1000
# cross-validation
